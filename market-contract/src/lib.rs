...
pub enum StorageKey {
    SaleKey,
    ByOwnerIdKey,
    InnterByOwnerIdKey { account_id_hash: CryptoHash },
    ByContractIdKey,
...
impl Contract {
    ...
    pub fn markdown_swap_token(
        &mut self,
        nft_contract_id: AccountId,
        token_id: TokenId,
        is_swap: bool,
    ) {
        // B1: get token sale theo token_id
        ...
        // B2: thay đổi trường is_swap trong token sale đó
        sale.is_swap = is_swap;

        // B3: update lại danh sách sales theo token_id
