...
for t in $@; do
  ...
  echo "=== ${t} ==="
  if [ -e "/Users/haitran/Learn_NEAR/NFT/target/debug/build/jemalloc-sys-808164a3a5d442a7/out/jemalloc/${t}.sh" ] ; then
    ...
    enable_fill=1 \
    enable_prof=0 \
    . /Users/haitran/Learn_NEAR/NFT/target/debug/build/jemalloc-sys-808164a3a5d442a7/out/jemalloc/${t}.sh && \
    export_malloc_conf && \
    $JEMALLOC_TEST_PREFIX ${t} /Users/haitran/Learn_NEAR/NFT/target/debug/build/jemalloc-sys-808164a3a5d442a7/out/jemalloc/ /Users/haitran/Learn_NEAR/NFT/target/debug/build/jemalloc-sys-808164a3a5d442a7/out/build/
  else
    export MALLOC_CONF= && \
    export_malloc_conf && \
    $JEMALLOC_TEST_PREFIX ${t} /Users/haitran/Learn_NEAR/NFT/target/debug/build/jemalloc-sys-808164a3a5d442a7/out/jemalloc/ /Users/haitran/Learn_NEAR/NFT/target/debug/build/jemalloc-sys-808164a3a5d442a7/out/build/
